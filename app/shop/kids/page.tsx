...
const products = [
  { name: "Soft Sweater", price: "$56" },
  { name: "Playful Set", price: "$62" },
  { name: "Comfort Tee", price: "$29" },
  { name: "Everyday Shorts", price: "$38" },
];
        ...
        <section className="max-w-7xl mx-auto px-6 py-20 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Discover easy, elevated childrenswear built for comfort, movement, and quiet sophistication.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2">
            {products.map((product) => (
              <div key={product.name} className="rounded-[2rem] border border-[#F1E7D6] bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
                ...
                <p className="mt-4 text-gray-600">Soft, stylish pieces for everyday play and effortless layering.</p>
