...
const products = [
  { name: "Structured Coat", price: "$169" },
  { name: "Tailored Shirt", price: "$98" },
  { name: "Minimal Knit", price: "$84" },
  { name: "Smart Trousers", price: "$124" },
];
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2">
            {products.map((product) => (
              <div key={product.name} className="rounded-[2rem] border border-[#F1E7D6] bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
                ...
                <p className="mt-4 text-gray-600">Modern wardrobe essentials crafted for enduring style and comfort.</p>
